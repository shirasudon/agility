...
export const withSelectedUsers = withState(
  'selectedUsers',
  'setSelectedUsers',
  []
)
...
export const MatchedUserList = ({
  ...
  return matchedUserList.length > 0 ? (
    <List> {matchedUserList} </List>
  ) : (
